"""
onestream.live/Destinations/update_button 元素实现

Element 子类，表示更新按钮。参考 autojs.py 中 update_button 定义。
"""
...
class UpdateButton(Element):
    """Onestream 更新按钮。"""

    def __init__(self, browser: Browser, node_name: str, domain: Domain, page: Page, language: str = "en-US"):
        super().__init__(browser=browser, node_name=node_name, domain=domain, page=page, description="Destinations.更新按钮", language=language)
