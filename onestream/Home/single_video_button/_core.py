"""
onestream.live/Home/single_video_button 元素实现

Element 子类，表示单视频按钮（Single Video）。参考 autojs.py 中 single_video_button 定义。
"""
...
class SingleVideoButton(Element):
    """Onestream 单视频按钮。"""

    def __init__(self, browser: Browser, node_name: str, domain: Domain, page: Page, language: str = "en-US"):
        super().__init__(browser=browser, node_name=node_name, domain=domain, page=page, description="Stream.单视频按钮", language=language)
