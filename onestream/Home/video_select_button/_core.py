"""
onestream.live/Home/video_select_button 元素实现

Element 子类，表示视频选择按钮。参考 autojs.py 中 video_select_button 定义。
"""
...
class VideoSelectButton(Element):
    """Onestream 视频选择按钮。"""

    def __init__(self, browser: Browser, node_name: str, domain: Domain, page: Page, language: str = "en-US"):
        super().__init__(browser=browser, node_name=node_name, domain=domain, page=page, description="Stream.视频选择按钮", language=language)
